...
export default function Header() {
  ...
  return (
    <div className="absolute top-24 w-full z-50">
      <div className="flex flex-col fixed -mt-24">
        ...
        <div className="w-full font-serif font-thin fixed h-12 bg-white flex mt-12 justify-center items-center text-black">
          <div className="absolute -left-2 flex z-50 sm:hidden">
            <button
              onClick={() => {
            ...
            <div
              className={`absolute -translate-x-48 left-0 -z-10 duration-200 ${
          ...
          <div className="flex flex-col pl-4 justify-center font-Prompt items-center">
            ...
            {!scrolledUp && (
              <div
                className={`flex -mt-1 font-serif ${
                  scrolledUp ? "animate-fadeOut" : "animate-fadeIn"
                } hidden sm:block`}
              >
                <Link to="/">
                  <button
                    className={`p-2 pt-0 pb-0 hover:border-b ${
                      "home" === isSelected ? "border-b-2 border-amber-400" : ""
                    }`}
                    onClick={() => {
                      setISSelected("home");
                    }}
                ...
                <Link to="/shirts">
                  <button
                    className={`m-2 mt-0 mb-0 hover:border-b ${
                      "shirts" === isSelected
          ...
          <div className="absolute right-1 sm:right-3">
            <Link to="/cart">
              <button className="flex">
                <p className="mr-2 text-amber-400 font-Prompt">
                  {cartItems.length}
                </p>{" "}
                {ShopLogo}
              </button>
