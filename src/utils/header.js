...
export default function Header(){
    ...
    return <div className="absolute top-24">
        ...
        <div className="w-screen font-serif font-thin fixed h-12 bg-white flex mt-12 justify-center items-center text-black">
       ...
       <div className="flex flex-col justify-center font-Prompt items-center">
       D&O
