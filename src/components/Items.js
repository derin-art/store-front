...
export default function Items() {
  ...
  const Decoy = [
    <div className="h-80 m-2 duration-75 ease-in-out bg-gray-300 animate-pulse border border-gray-400 w-48"></div>,
    <div className="h-80 m-2 duration-75 ease-in-out bg-gray-300 animate-pulse border border-gray-400 w-48"></div>,
    <div className="h-80 m-2 duration-75 ease-in-out bg-gray-300 animate-pulse border border-gray-400 w-48"></div>,
    <div className="h-80 m-2 duration-75 ease-in-out bg-gray-300 animate-pulse border border-gray-400 w-48"></div>,
    <div className="h-80 m-2 duration-75 ease-in-out bg-gray-300 animate-pulse border border-gray-400 w-48"></div>,
  ...
  return (
    <div>
      <div className="mt-12 flex flex-wrap items-center justify-center">
        <div
          className={`${
            items.length ? "hidden" : "block"
          } items-center justify-center flex flex-wrap w-full scrollbar-hide`}
        >
          {" "}
          {Decoy}
        </div>
